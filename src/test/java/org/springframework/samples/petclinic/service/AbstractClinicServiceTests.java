 ...
 *
 * <p>Subclasses should specify Spring context configuration using {@link
 * ContextConfiguration @ContextConfiguration} annotation
 *
 * <p>AbstractclinicServiceTests and its subclasses benefit from the following services provided by
 ...
 *       <code>{@link
 * AbstractClinicServiceTests#clinicService clinicService}</code> instance variable, which uses
