...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
  ...
  public JdbcOwnerRepositoryImpl(
      DataSource dataSource, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {

    this.insertOwner =
        new SimpleJdbcInsert(dataSource).withTableName("owners").usingGeneratedKeyColumns("id");
  ...
  /**
   * Loads the {@link Pet} and {@link Visit} data for the supplied {@link List} of {@link Owner
   * Owners}.
   *
